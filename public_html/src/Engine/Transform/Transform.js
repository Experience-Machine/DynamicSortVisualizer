...
function Transform() {
    ...
    this.mDestination = vec2.fromValues(0, 0);  // this is for animation
...
Transform.prototype.setDestination = function (xPos, yPos) { this.mDestination[0] = xPos; this.mDestination[1] = yPos; };
Transform.prototype.getDestination = function () { return this.mDestination; };
Transform.prototype.getXDest = function () { return this.mDestination[0]; };
Transform.prototype.setXDest = function (xPos) { this.mDestination[0] = xPos; };
Transform.prototype.getYDest = function () { return this.mDestination[1]; };
Transform.prototype.setYDest = function (yPos) { this.mDestination[1] = yPos; };
//</editor-fold>
